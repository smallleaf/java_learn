 ...
 * @since 4.2
 */
public class ApplicationListenerMethodAdapter2 implements GenericApplicationListener {

	private static final boolean reactiveStreamsPresent = ClassUtils.isPresent(
			"org.reactivestreams.Publisher", ApplicationListenerMethodAdapter2.class.getClassLoader());
	...
	public ApplicationListenerMethodAdapter2(String beanName, Class<?> targetClass, Method method) {
